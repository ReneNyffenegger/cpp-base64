...
Passion for data)";
    ...
    cout << "---Encode - No Linebreaks, Safe Url Base64 ---" << endl << Base64::Encode("HelloWorld!!!", true, NO_LINE_BREAKS) << endl << endl;
    cout << "---Encode - No Linebreaks, Unsafe Url Base64 ---" << endl << Base64::Encode("HelloWorld!!!", false) << endl << endl;
    ...
    cout << "---Encode - Linebreaks, Safe Url Base64 ---" << endl << Base64::Encode(toEncode, true, LINE_BREAKS_APPEAR_MIME) << endl << endl;
    cout << "---Encode - Linebreaks, Unsafe Url Base64 ---" << endl << Base64::Encode(toEncode, false, LINE_BREAKS_APPEAR_MIME) << endl << endl;
...
bGxvV29ybGQhISE=)";
    ...
    cout << "---Inserting Linebreaks Default Format MIME 76 ---" << endl << Base64::InsertLineBreaks(toDecode3) << endl << endl;
    cout << "---Inserting Linebreaks PEM Format 64 ---" << endl << Base64::InsertLineBreaks(toDecode4, LINE_BREAKS_APPEAR_PEM) << endl << endl;
